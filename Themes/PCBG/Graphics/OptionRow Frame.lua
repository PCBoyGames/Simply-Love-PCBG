...
t[#t+1] = Def.Quad {
	...
	OnCommand=cmd(zoomto,_screen.w*0.85,_screen.h*0.0625;diffuse,Color.Black;);
}

-- black quad behind the title
t[#t+1] = Def.Quad {
	Name="TitleBackgroundQuad",
	OnCommand=cmd(halign, 0; x, -_screen.cx/1.1775; zoomto,_screen.w*WideScale(0.18,0.15),_screen.h*0.0625; diffuse, Color.White; diffusealpha, BrighterOptionRows() and 1 or 1);
}

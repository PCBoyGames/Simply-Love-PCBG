...
local pd = Def.ActorFrame{
	...
	SetCommand=function(self)
		...
		self:GetChild("MachineHighScoreName"):settext(machine_name):diffuse({1,1,1,1})
...
pd[#pd+1] = Def.Quad{
	Name="BackgroundQuad",
	InitCommand=cmd(zoomto, (_screen.w/2-10)+1, (_screen.h/8)+1; y, _screen.h/2 - 67 ),
...
pd[#pd+1] = Def.BitmapText{
	...
	InitCommand=cmd(x, highscoreX; y, 156; zoom, zoom_factor; diffuse, Color.White; halign, 1 )
}
...
pd[#pd+1] = Def.BitmapText{
	...
	InitCommand=cmd(x, highscorenameX; y, 156; zoom, zoom_factor; diffuse, Color.White; halign, 0; maxwidth, 80)
}
...
pd[#pd+1] = Def.BitmapText{
	...
	InitCommand=cmd(x, highscoreX; y, 176; zoom, zoom_factor; diffuse, Color.White; halign, 1 )
}
...
pd[#pd+1] = Def.BitmapText{
	...
	InitCommand=cmd(x, highscorenameX; y, 176; zoom, zoom_factor; diffuse, Color.White; halign, 0; maxwidth, 80)
}

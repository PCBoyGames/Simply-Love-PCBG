...
local t = Def.ActorFrame {
	...
	LoadActor(img)..{
		InitCommand=cmd(zoom,0.8;y,150;diffusealpha,0;rotationz,10;);
		OnCommand=cmd(accelerate,0.4;y,0;diffusealpha,0.75;rotationz,-10;sleep,1.3;decelerate,0.4;diffusealpha,0;y,-150;);
	};
};
return t;
